...
public class CustomAccount extends Account implements AccountService {
    ...
    public CustomAccount() throws IOException {
        ...
        if (!f.exists()) {
            String[] names = {"Вася", "Петя", "Маша", "Леша", "Андрей", "Афанасий", "Лена", "Катя", "Миша", "Вова"};
    ...
    public void withdraw(int accountId, int amount) throws IOException {
        try {
            ...
            if (account == null) {
                throw new UnknownAccountException("Счет не найден");
            }
    ...
    public void transfer(int from, int to, int amount) throws IOException {
        ...
        try {
            if (accountFrom == null) {
                throw new UnknownAccountException("Счет " +  from + " не найден");
            }
            if (accountTo == null) {
                throw new UnknownAccountException("Счет " +  to + " не найден");
            }
